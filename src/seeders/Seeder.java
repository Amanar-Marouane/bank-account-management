...
public class Seeder {
    public static void run() {
        ...
        Customer customer1 = new Customer("Marouane", "Amanar", "marouane@email.com", "mmMM00!!");
        customerRepo.save(customer1);

        // Create second customer
        Customer customer2 = new Customer("Omar", "Ouyacho", "omar@email.com", "llLL00!!");
        ...
        Console.info("Created 2 customers with accounts and transactions.");
    }
}